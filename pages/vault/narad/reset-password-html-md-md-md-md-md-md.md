---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/reset-password-html-md-md-md-md-md.md"
project: "narad"
role: auth
language: markdown
frameworks: [docker]
...
# reset-password-html-md-md-md-md-md.md

> Authentication / authorization module using **docker** (412 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/reset-password-html-md-md-md-md-md.md` |
| **Role** | auth |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 412 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/reset-password-html-md-md-md-md.md"
project: "narad"
role: auth
language: markdown
frameworks: [docker]
...
# reset-password-html-md-md-md-md.md

> Authentication / authorization module using **docker** (374 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/reset-password-html-md-md-md-md.md` |
| **Role** | auth |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 374 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/reset-password-html-md-md-md.md"
project: "narad"
role: auth
language: markdown
frameworks: [docker]
...
# reset-password-html-md-md-md.md

> Authentication / authorization module using **docker** (336 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/reset-password-html-md-md-md.md` |
| **Role** | auth |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 336 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/reset-password-html-md-md.md"
project: "narad"
role: auth
language: markdown
frameworks: [docker]
...
# reset-password-html-md-md.md

> Authentication / authorization module using **docker** (298 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/reset-password-html-md-md.md` |
| **Role** | auth |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 298 |
