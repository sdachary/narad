---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/project-development-md-md-md-md-md.md"
project: "narad"
role: docs
language: markdown
...
# project-development-md-md-md-md-md.md

> Documentation using **docker, typescript** (481 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/project-development-md-md-md-md-md.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | docker, typescript |
| **Lines** | 481 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/project-development-md-md-md-md.md"
project: "narad"
role: docs
language: markdown
frameworks: [docker, typescript]
...
# project-development-md-md-md-md.md

> Documentation using **docker, typescript** (443 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/project-development-md-md-md-md.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | docker, typescript |
| **Lines** | 443 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/project-development-md-md-md.md"
project: "narad"
role: docs
language: markdown
frameworks: [docker, typescript]
...
# project-development-md-md-md.md

> Documentation using **docker, typescript** (405 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/project-development-md-md-md.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | docker, typescript |
| **Lines** | 405 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/project-development-md-md.md"
project: "narad"
role: docs
language: markdown
frameworks: [docker, typescript]
...
# project-development-md-md.md

> Documentation using **docker, typescript** (367 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/project-development-md-md.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | docker, typescript |
| **Lines** | 367 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/project-development-md.md"
project: "narad"
role: docs
language: markdown
frameworks: [docker, typescript]
...
# project-development-md.md

> Documentation using **docker, typescript** (329 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/project-development-md.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | docker, typescript |
| **Lines** | 329 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/skills/project-development.md"
project: "narad"
role: docs
language: markdown
frameworks: [docker, typescript]
...
> Documentation using **docker, typescript** (291 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/skills/project-development.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | docker, typescript |
| **Lines** | 291 |
