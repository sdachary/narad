---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/context-optimization-md-md-md-md-md.md"
project: "narad"
role: docs
language: markdown
frameworks: [docker]
...
# context-optimization-md-md-md-md-md.md

> Documentation using **docker** (385 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/context-optimization-md-md-md-md-md.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 385 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/context-optimization-md-md-md-md.md"
project: "narad"
role: docs
language: markdown
frameworks: [docker]
...
# context-optimization-md-md-md-md.md

> Documentation using **docker** (347 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/context-optimization-md-md-md-md.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 347 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/context-optimization-md-md-md.md"
project: "narad"
role: docs
language: markdown
frameworks: [docker]
...
# context-optimization-md-md-md.md

> Documentation using **docker** (309 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/context-optimization-md-md-md.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 309 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/context-optimization-md-md.md"
project: "narad"
role: docs
language: markdown
frameworks: [docker]
...
# context-optimization-md-md.md

> Documentation using **docker** (271 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/context-optimization-md-md.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 271 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/context-optimization-md.md"
project: "narad"
role: docs
language: markdown
frameworks: [docker]
...
# context-optimization-md.md

> Documentation using **docker** (233 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/context-optimization-md.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 233 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/skills/context-optimization.md"
project: "narad"
role: docs
language: markdown
frameworks: [docker]
...
> Documentation using **docker** (195 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/skills/context-optimization.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 195 |
