---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/tool-design-md-md-md-md-md.md"
project: "narad"
role: docs
language: markdown
frameworks: [docker]
...
# tool-design-md-md-md-md-md.md

> Documentation using **docker** (461 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/tool-design-md-md-md-md-md.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 461 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/tool-design-md-md-md-md.md"
project: "narad"
role: docs
language: markdown
frameworks: [docker]
...
# tool-design-md-md-md-md.md

> Documentation using **docker** (423 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/tool-design-md-md-md-md.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 423 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/tool-design-md-md-md.md"
project: "narad"
role: docs
language: markdown
frameworks: [docker]
...
| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/tool-design-md-md-md.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 385 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/tool-design-md-md.md"
project: "narad"
role: docs
language: markdown
frameworks: [docker]
...
| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/tool-design-md-md.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 347 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/tool-design-md.md"
project: "narad"
role: docs
language: markdown
frameworks: [docker]
...
| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/tool-design-md.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 309 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/skills/tool-design.md"
project: "narad"
role: docs
language: markdown
frameworks: [docker]
...
| Property | Value |
|----------|-------|
| **Path** | `narad/skills/tool-design.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 271 |
