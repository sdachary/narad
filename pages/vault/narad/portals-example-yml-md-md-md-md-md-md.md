---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/portals-example-yml-md-md-md-md-md.md"
project: "narad"
role: docs
language: markdown
frameworks: [docker]
...
# portals-example-yml-md-md-md-md-md.md

> Documentation using **docker** (947 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/portals-example-yml-md-md-md-md-md.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 947 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/portals-example-yml-md-md-md-md.md"
project: "narad"
role: docs
language: markdown
frameworks: [docker]
...
# portals-example-yml-md-md-md-md.md

> Documentation using **docker** (909 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/portals-example-yml-md-md-md-md.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 909 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/portals-example-yml-md-md-md.md"
project: "narad"
role: docs
language: markdown
frameworks: [docker]
...
# portals-example-yml-md-md-md.md

> Documentation using **docker** (871 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/portals-example-yml-md-md-md.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 871 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/portals-example-yml-md-md.md"
project: "narad"
role: docs
language: markdown
frameworks: [docker]
...
# portals-example-yml-md-md.md

> Documentation using **docker** (833 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/portals-example-yml-md-md.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 833 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/portals-example-yml-md.md"
project: "narad"
role: docs
language: markdown
frameworks: [docker]
...
# portals-example-yml-md.md

> Documentation using **docker** (795 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/portals-example-yml-md.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 795 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/unnati/portals-example-yml.md"
project: "narad"
role: docs
language: markdown
frameworks: [docker]
...
# portals-example-yml.md

> Documentation using **docker** (757 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/unnati/portals-example-yml.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 757 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/unnati/career-ops/templates/portals.example.yml"
project: "unnati"
role: service
language: yaml
frameworks: [docker]
...
> Service / API client module using **docker** (719 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `unnati/career-ops/templates/portals.example.yml` |
| **Role** | service |
| **Language** | yaml |
| **Frameworks** | docker |
| **Lines** | 719 |
