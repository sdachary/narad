---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/context-degradation-md-md-md-md-md.md"
project: "narad"
role: auth
language: markdown
frameworks: [docker]
...
# context-degradation-md-md-md-md-md.md

> Authentication / authorization module using **docker** (396 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/context-degradation-md-md-md-md-md.md` |
| **Role** | auth |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 396 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/context-degradation-md-md-md-md.md"
project: "narad"
role: auth
language: markdown
frameworks: [docker]
...
# context-degradation-md-md-md-md.md

> Authentication / authorization module using **docker** (358 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/context-degradation-md-md-md-md.md` |
| **Role** | auth |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 358 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/context-degradation-md-md-md.md"
project: "narad"
role: auth
language: markdown
frameworks: [docker]
...
# context-degradation-md-md-md.md

> Authentication / authorization module using **docker** (320 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/context-degradation-md-md-md.md` |
| **Role** | auth |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 320 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/context-degradation-md-md.md"
project: "narad"
role: auth
language: markdown
frameworks: [docker]
...
# context-degradation-md-md.md

> Authentication / authorization module using **docker** (282 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/context-degradation-md-md.md` |
| **Role** | auth |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 282 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/context-degradation-md.md"
project: "narad"
role: auth
language: markdown
frameworks: [docker]
...
# context-degradation-md.md

> Authentication / authorization module using **docker** (244 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/context-degradation-md.md` |
| **Role** | auth |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 244 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/skills/context-degradation.md"
project: "narad"
role: auth
language: markdown
frameworks: [docker]
...
> Authentication / authorization module using **docker** (206 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/skills/context-degradation.md` |
| **Role** | auth |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 206 |
