---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/QuickActions-tsx-md-md-md-md-md.md"
project: "narad"
role: route
language: markdown
frameworks: [react]
...
# QuickActions-tsx-md-md-md-md-md.md

> Route handler / API endpoint using **react** (377 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/QuickActions-tsx-md-md-md-md-md.md` |
| **Role** | route |
| **Language** | markdown |
| **Frameworks** | react |
| **Lines** | 377 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/QuickActions-tsx-md-md-md-md.md"
project: "narad"
role: route
language: markdown
frameworks: [react]
...
# QuickActions-tsx-md-md-md-md.md

> Route handler / API endpoint using **react** (339 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/QuickActions-tsx-md-md-md-md.md` |
| **Role** | route |
| **Language** | markdown |
| **Frameworks** | react |
| **Lines** | 339 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/QuickActions-tsx-md-md-md.md"
project: "narad"
role: route
language: markdown
frameworks: [react]
...
# QuickActions-tsx-md-md-md.md

> Route handler / API endpoint using **react** (301 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/QuickActions-tsx-md-md-md.md` |
| **Role** | route |
| **Language** | markdown |
| **Frameworks** | react |
| **Lines** | 301 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/QuickActions-tsx-md-md.md"
project: "narad"
role: route
language: markdown
frameworks: [react]
...
# QuickActions-tsx-md-md.md

> Route handler / API endpoint using **react** (263 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/QuickActions-tsx-md-md.md` |
| **Role** | route |
| **Language** | markdown |
| **Frameworks** | react |
| **Lines** | 263 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/QuickActions-tsx-md.md"
project: "narad"
role: route
language: markdown
frameworks: [react]
...
# QuickActions-tsx-md.md

> Route handler / API endpoint using **react** (225 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/QuickActions-tsx-md.md` |
| **Role** | route |
| **Language** | markdown |
| **Frameworks** | react |
| **Lines** | 225 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/unnati/QuickActions-tsx.md"
project: "narad"
role: route
language: markdown
frameworks: [react]
...
> Route handler / API endpoint using **react** (187 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/unnati/QuickActions-tsx.md` |
| **Role** | route |
| **Language** | markdown |
| **Frameworks** | react |
| **Lines** | 187 |
