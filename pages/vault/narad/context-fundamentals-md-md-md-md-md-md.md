---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/context-fundamentals-md-md-md-md-md.md"
project: "narad"
role: auth
language: markdown
frameworks: [docker]
...
# context-fundamentals-md-md-md-md-md.md

> Authentication / authorization module using **docker** (391 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/context-fundamentals-md-md-md-md-md.md` |
| **Role** | auth |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 391 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/context-fundamentals-md-md-md-md.md"
project: "narad"
role: auth
language: markdown
frameworks: [docker]
...
# context-fundamentals-md-md-md-md.md

> Authentication / authorization module using **docker** (353 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/context-fundamentals-md-md-md-md.md` |
| **Role** | auth |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 353 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/context-fundamentals-md-md-md.md"
project: "narad"
role: auth
language: markdown
frameworks: [docker]
...
# context-fundamentals-md-md-md.md

> Authentication / authorization module using **docker** (315 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/context-fundamentals-md-md-md.md` |
| **Role** | auth |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 315 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/context-fundamentals-md-md.md"
project: "narad"
role: auth
language: markdown
frameworks: [docker]
...
# context-fundamentals-md-md.md

> Authentication / authorization module using **docker** (277 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/context-fundamentals-md-md.md` |
| **Role** | auth |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 277 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/context-fundamentals-md.md"
project: "narad"
role: auth
language: markdown
frameworks: [docker]
...
# context-fundamentals-md.md

> Authentication / authorization module using **docker** (239 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/context-fundamentals-md.md` |
| **Role** | auth |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 239 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/skills/context-fundamentals.md"
project: "narad"
role: auth
language: markdown
frameworks: [docker]
...
> Authentication / authorization module using **docker** (201 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/skills/context-fundamentals.md` |
| **Role** | auth |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 201 |
