---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/cv-md-md-md-md-md-md.md"
project: "narad"
role: service
language: markdown
frameworks: [docker]
...
# cv-md-md-md-md-md-md.md

> Service / API client module using **docker** (308 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/cv-md-md-md-md-md-md.md` |
| **Role** | service |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 308 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/cv-md-md-md-md-md.md"
project: "narad"
role: service
language: markdown
frameworks: [docker]
...
# cv-md-md-md-md-md.md

> Service / API client module using **docker** (270 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/cv-md-md-md-md-md.md` |
| **Role** | service |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 270 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/cv-md-md-md-md.md"
project: "narad"
role: service
language: markdown
frameworks: [docker]
...
> Service / API client module using **docker** (232 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/cv-md-md-md-md.md` |
| **Role** | service |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 232 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/cv-md-md-md.md"
project: "narad"
role: service
language: markdown
frameworks: [docker]
...
> Service / API client module using **docker** (194 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/cv-md-md-md.md` |
| **Role** | service |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 194 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/cv-md-md.md"
project: "narad"
role: service
language: markdown
frameworks: [docker]
...
> Service / API client module using **docker** (156 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/cv-md-md.md` |
| **Role** | service |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 156 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/career-ops/cv-md.md"
project: "narad"
role: service
language: markdown
frameworks: [docker]
...
> Service / API client module using **docker** (118 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/career-ops/cv-md.md` |
| **Role** | service |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 118 |
...
```markdown
---
source: "/home/deepak/Work/career-ops/examples/dual-track-engineer-instructor/cv.md"
project: "career-ops"
role: service
language: markdown
frameworks: [docker]
...
tags: [docker, documentation, markdown, project/career-ops, service]
---

# cv.md

> Service / API client module using **docker** (80 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `career-ops/examples/dual-track-engineer-instructor/cv.md` |
| **Role** | service |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 80 |
