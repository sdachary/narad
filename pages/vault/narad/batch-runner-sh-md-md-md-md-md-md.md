---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/batch-runner-sh-md-md-md-md-md.md"
project: "narad"
role: script
language: markdown
frameworks: [docker]
...
# batch-runner-sh-md-md-md-md-md.md

> Automation script using **docker** (714 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/batch-runner-sh-md-md-md-md-md.md` |
| **Role** | script |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 714 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/batch-runner-sh-md-md-md-md.md"
project: "narad"
role: script
language: markdown
frameworks: [docker]
...
# batch-runner-sh-md-md-md-md.md

> Automation script using **docker** (676 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/batch-runner-sh-md-md-md-md.md` |
| **Role** | script |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 676 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/batch-runner-sh-md-md-md.md"
project: "narad"
role: script
language: markdown
frameworks: [docker]
...
# batch-runner-sh-md-md-md.md

> Automation script using **docker** (638 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/batch-runner-sh-md-md-md.md` |
| **Role** | script |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 638 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/batch-runner-sh-md-md.md"
project: "narad"
role: script
language: markdown
frameworks: [docker]
...
# batch-runner-sh-md-md.md

> Automation script using **docker** (600 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/batch-runner-sh-md-md.md` |
| **Role** | script |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 600 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/batch-runner-sh-md.md"
project: "narad"
role: script
language: markdown
frameworks: [docker]
...
# batch-runner-sh-md.md

> Automation script using **docker** (562 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/batch-runner-sh-md.md` |
| **Role** | script |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 562 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/unnati/batch-runner-sh.md"
project: "narad"
role: script
language: markdown
frameworks: [docker]
...
> Automation script using **docker** (524 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/unnati/batch-runner-sh.md` |
| **Role** | script |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 524 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/unnati/career-ops/batch/batch-runner.sh"
project: "unnati"
role: script
language: bash
frameworks: [docker]
...
> Automation script using **docker** (486 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `unnati/career-ops/batch/batch-runner.sh` |
| **Role** | script |
| **Language** | bash |
| **Frameworks** | docker |
| **Lines** | 486 |
