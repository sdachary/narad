---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/output-skill-md-md-md-md-md.md"
project: "narad"
role: docs
language: markdown
frameworks: [docker]
...
# output-skill-md-md-md-md-md.md
...
| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/output-skill-md-md-md-md-md.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 349 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/output-skill-md-md-md-md.md"
project: "narad"
role: docs
language: markdown
frameworks: [docker]
...
| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/output-skill-md-md-md-md.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 311 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/output-skill-md-md-md.md"
project: "narad"
role: docs
language: markdown
frameworks: [docker]
...
# output-skill-md-md-md.md

> Documentation using **docker** (273 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/output-skill-md-md-md.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 273 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/output-skill-md-md.md"
project: "narad"
role: docs
language: markdown
frameworks: [docker]
...
# output-skill-md-md.md

> Documentation using **docker** (235 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/output-skill-md-md.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 235 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/output-skill-md.md"
project: "narad"
role: docs
language: markdown
frameworks: [docker]
...
> Documentation using **docker** (197 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/output-skill-md.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 197 |
