---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/terms-html-md-md-md-md-md.md"
project: "narad"
role: service
language: markdown
frameworks: [docker]
...
# terms-html-md-md-md-md-md.md

> Service / API client module using **docker** (304 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/terms-html-md-md-md-md-md.md` |
| **Role** | service |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 304 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/terms-html-md-md-md-md.md"
project: "narad"
role: service
language: markdown
frameworks: [docker]
...
# terms-html-md-md-md-md.md

> Service / API client module using **docker** (266 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/terms-html-md-md-md-md.md` |
| **Role** | service |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 266 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/terms-html-md-md-md.md"
project: "narad"
role: service
language: markdown
frameworks: [docker]
...
# terms-html-md-md-md.md

> Service / API client module using **docker** (228 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/terms-html-md-md-md.md` |
| **Role** | service |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 228 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/terms-html-md-md.md"
project: "narad"
role: service
language: markdown
frameworks: [docker]
...
> Service / API client module using **docker** (190 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/terms-html-md-md.md` |
| **Role** | service |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 190 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/terms-html-md.md"
project: "narad"
role: service
language: markdown
frameworks: [docker]
...
> Service / API client module using **docker** (152 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/terms-html-md.md` |
| **Role** | service |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 152 |
