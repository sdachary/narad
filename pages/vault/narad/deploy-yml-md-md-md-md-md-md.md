---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/deploy-yml-md-md-md-md-md.md"
project: "narad"
role: config
language: markdown
...
# deploy-yml-md-md-md-md-md.md

> Configuration file for the project using **cloudflare-workers, github-actions, vite** (277 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/deploy-yml-md-md-md-md-md.md` |
| **Role** | config |
| **Language** | markdown |
| **Frameworks** | cloudflare-workers, github-actions, vite |
| **Lines** | 277 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/deploy-yml-md-md-md-md.md"
project: "narad"
role: config
language: markdown
frameworks: [cloudflare-workers, github-actions, vite]
...
# deploy-yml-md-md-md-md.md

> Configuration file for the project using **cloudflare-workers, github-actions, vite** (239 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/deploy-yml-md-md-md-md.md` |
| **Role** | config |
| **Language** | markdown |
| **Frameworks** | cloudflare-workers, github-actions, vite |
| **Lines** | 239 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/deploy-yml-md-md-md.md"
project: "narad"
role: config
language: markdown
frameworks: [cloudflare-workers, github-actions, vite]
...
# deploy-yml-md-md-md.md

> Configuration file for the project using **cloudflare-workers, github-actions, vite** (201 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/deploy-yml-md-md-md.md` |
| **Role** | config |
| **Language** | markdown |
| **Frameworks** | cloudflare-workers, github-actions, vite |
| **Lines** | 201 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/deploy-yml-md-md.md"
project: "narad"
role: config
language: markdown
frameworks: [cloudflare-workers, github-actions, vite]
...
> Configuration file for the project using **cloudflare-workers, github-actions, vite** (163 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/deploy-yml-md-md.md` |
| **Role** | config |
| **Language** | markdown |
| **Frameworks** | cloudflare-workers, github-actions, vite |
| **Lines** | 163 |
