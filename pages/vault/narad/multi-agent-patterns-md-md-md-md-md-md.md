---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/multi-agent-patterns-md-md-md-md-md.md"
project: "narad"
role: docs
language: markdown
frameworks: [docker]
...
# multi-agent-patterns-md-md-md-md-md.md

> Documentation using **docker** (447 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/multi-agent-patterns-md-md-md-md-md.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 447 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/multi-agent-patterns-md-md-md-md.md"
project: "narad"
role: docs
language: markdown
frameworks: [docker]
...
# multi-agent-patterns-md-md-md-md.md

> Documentation using **docker** (409 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/multi-agent-patterns-md-md-md-md.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 409 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/multi-agent-patterns-md-md-md.md"
project: "narad"
role: docs
language: markdown
frameworks: [docker]
...
# multi-agent-patterns-md-md-md.md

> Documentation using **docker** (371 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/multi-agent-patterns-md-md-md.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 371 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/multi-agent-patterns-md-md.md"
project: "narad"
role: docs
language: markdown
frameworks: [docker]
...
# multi-agent-patterns-md-md.md

> Documentation using **docker** (333 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/multi-agent-patterns-md-md.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 333 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/multi-agent-patterns-md.md"
project: "narad"
role: docs
language: markdown
frameworks: [docker]
...
# multi-agent-patterns-md.md

> Documentation using **docker** (295 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/multi-agent-patterns-md.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 295 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/skills/multi-agent-patterns.md"
project: "narad"
role: docs
language: markdown
frameworks: [docker]
...
> Documentation using **docker** (257 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/skills/multi-agent-patterns.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 257 |
