---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/claude-api-md-md-md-md-md.md"
project: "narad"
role: config
language: markdown
...
# claude-api-md-md-md-md-md.md

> Configuration file for the project using **docker, typescript** (452 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/claude-api-md-md-md-md-md.md` |
| **Role** | config |
| **Language** | markdown |
| **Frameworks** | docker, typescript |
| **Lines** | 452 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/claude-api-md-md-md-md.md"
project: "narad"
role: config
language: markdown
frameworks: [docker, typescript]
...
# claude-api-md-md-md-md.md

> Configuration file for the project using **docker, typescript** (414 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/claude-api-md-md-md-md.md` |
| **Role** | config |
| **Language** | markdown |
| **Frameworks** | docker, typescript |
| **Lines** | 414 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/claude-api-md-md-md.md"
project: "narad"
role: config
language: markdown
frameworks: [docker, typescript]
...
# claude-api-md-md-md.md

> Configuration file for the project using **docker, typescript** (376 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/claude-api-md-md-md.md` |
| **Role** | config |
| **Language** | markdown |
| **Frameworks** | docker, typescript |
| **Lines** | 376 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/claude-api-md-md.md"
project: "narad"
role: config
language: markdown
frameworks: [docker, typescript]
...
> Configuration file for the project using **docker, typescript** (338 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/claude-api-md-md.md` |
| **Role** | config |
| **Language** | markdown |
| **Frameworks** | docker, typescript |
| **Lines** | 338 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/claude-api-md.md"
project: "narad"
role: config
language: markdown
frameworks: [docker, typescript]
...
> Configuration file for the project using **docker, typescript** (300 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/claude-api-md.md` |
| **Role** | config |
| **Language** | markdown |
| **Frameworks** | docker, typescript |
| **Lines** | 300 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/skills/claude-api.md"
project: "narad"
role: config
language: markdown
frameworks: [docker, typescript]
...
> Configuration file for the project using **docker, typescript** (262 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/skills/claude-api.md` |
| **Role** | config |
| **Language** | markdown |
| **Frameworks** | docker, typescript |
| **Lines** | 262 |
