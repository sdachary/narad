---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/soft-skill-md-md-md-md-md.md"
project: "narad"
role: docs
language: markdown
frameworks: [docker]
...
# soft-skill-md-md-md-md-md.md

> Documentation using **docker** (321 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/soft-skill-md-md-md-md-md.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 321 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/soft-skill-md-md-md-md.md"
project: "narad"
role: docs
language: markdown
frameworks: [docker]
...
# soft-skill-md-md-md-md.md

> Documentation using **docker** (283 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/soft-skill-md-md-md-md.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 283 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/soft-skill-md-md-md.md"
project: "narad"
role: docs
language: markdown
frameworks: [docker]
...
# soft-skill-md-md-md.md

> Documentation using **docker** (245 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/soft-skill-md-md-md.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 245 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/soft-skill-md-md.md"
project: "narad"
role: docs
language: markdown
frameworks: [docker]
...
> Documentation using **docker** (207 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/soft-skill-md-md.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 207 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/soft-skill-md.md"
project: "narad"
role: docs
language: markdown
frameworks: [docker]
...
> Documentation using **docker** (169 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/soft-skill-md.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 169 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/skills/soft-skill.md"
project: "narad"
role: docs
language: markdown
frameworks: [docker]
...
> Documentation using **docker** (132 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/skills/soft-skill.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 132 |
