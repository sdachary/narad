---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/advanced-evaluation-md-md-md-md-md.md"
project: "narad"
role: docs
language: markdown
frameworks: [docker]
...
# advanced-evaluation-md-md-md-md-md.md

> Documentation using **docker** (592 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/advanced-evaluation-md-md-md-md-md.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 592 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/advanced-evaluation-md-md-md-md.md"
project: "narad"
role: docs
language: markdown
frameworks: [docker]
...
# advanced-evaluation-md-md-md-md.md

> Documentation using **docker** (554 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/advanced-evaluation-md-md-md-md.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 554 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/advanced-evaluation-md-md-md.md"
project: "narad"
role: docs
language: markdown
frameworks: [docker]
...
# advanced-evaluation-md-md-md.md

> Documentation using **docker** (516 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/advanced-evaluation-md-md-md.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 516 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/advanced-evaluation-md-md.md"
project: "narad"
role: docs
language: markdown
frameworks: [docker]
...
# advanced-evaluation-md-md.md

> Documentation using **docker** (478 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/advanced-evaluation-md-md.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 478 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/advanced-evaluation-md.md"
project: "narad"
role: docs
language: markdown
frameworks: [docker]
...
# advanced-evaluation-md.md

> Documentation using **docker** (440 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/advanced-evaluation-md.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 440 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/skills/advanced-evaluation.md"
project: "narad"
role: docs
language: markdown
frameworks: [docker]
...
> Documentation using **docker** (402 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/skills/advanced-evaluation.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 402 |
