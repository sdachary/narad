---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/filesystem-context-md-md-md-md-md.md"
project: "narad"
role: auth
language: markdown
frameworks: [docker]
...
# filesystem-context-md-md-md-md-md.md

> Authentication / authorization module using **docker** (477 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/filesystem-context-md-md-md-md-md.md` |
| **Role** | auth |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 477 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/filesystem-context-md-md-md-md.md"
project: "narad"
role: auth
language: markdown
frameworks: [docker]
...
# filesystem-context-md-md-md-md.md

> Authentication / authorization module using **docker** (439 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/filesystem-context-md-md-md-md.md` |
| **Role** | auth |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 439 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/filesystem-context-md-md-md.md"
project: "narad"
role: auth
language: markdown
frameworks: [docker]
...
# filesystem-context-md-md-md.md

> Authentication / authorization module using **docker** (401 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/filesystem-context-md-md-md.md` |
| **Role** | auth |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 401 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/filesystem-context-md-md.md"
project: "narad"
role: auth
language: markdown
frameworks: [docker]
...
# filesystem-context-md-md.md

> Authentication / authorization module using **docker** (363 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/filesystem-context-md-md.md` |
| **Role** | auth |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 363 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/filesystem-context-md.md"
project: "narad"
role: auth
language: markdown
frameworks: [docker]
...
# filesystem-context-md.md

> Authentication / authorization module using **docker** (325 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/filesystem-context-md.md` |
| **Role** | auth |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 325 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/skills/filesystem-context.md"
project: "narad"
role: auth
language: markdown
frameworks: [docker]
...
> Authentication / authorization module using **docker** (287 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/skills/filesystem-context.md` |
| **Role** | auth |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 287 |
