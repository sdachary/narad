---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/agents-js-md-md-md-md.md"
project: "narad"
role: docs
language: markdown
frameworks: []
...
| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/agents-js-md-md-md-md.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | — |
| **Lines** | 481 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/agents-js-md-md-md.md"
project: "narad"
role: docs
language: markdown
frameworks: []
...
| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/agents-js-md-md-md.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | — |
| **Lines** | 443 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/agents-js-md-md.md"
project: "narad"
role: docs
language: markdown
frameworks: []
...
| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/agents-js-md-md.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | — |
| **Lines** | 405 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/agents-js-md.md"
project: "narad"
role: docs
language: markdown
frameworks: []
...
| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/agents-js-md.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | — |
| **Lines** | 367 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/agents-js.md"
project: "narad"
role: docs
language: markdown
frameworks: []
...
| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/agents-js.md` |
| **Role** | docs |
| **Language** | markdown |
| **Frameworks** | — |
| **Lines** | 329 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/config/agents.js"
project: "narad"
role: docs
language: javascript
frameworks: []
...
tags: [code, docs, javascript, project/narad]
---
...
**Key exports:** `WAREHOUSE_INDEX`, `SUBAGENTS`, `WAREHOUSE_AGENTS`, `ALL_AGENTS`

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/config/agents.js` |
| **Role** | docs |
| **Language** | javascript |
| **Frameworks** | — |
| **Lines** | 289 |
