---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/batch-prompt-md-md-md-md-md-md.md"
project: "narad"
role: config
language: markdown
frameworks: [docker]
...
# batch-prompt-md-md-md-md-md-md.md

> Configuration file for the project using **docker** (585 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/batch-prompt-md-md-md-md-md-md.md` |
| **Role** | config |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 585 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/batch-prompt-md-md-md-md-md.md"
project: "narad"
role: config
language: markdown
frameworks: [docker]
...
# batch-prompt-md-md-md-md-md.md

> Configuration file for the project using **docker** (547 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/batch-prompt-md-md-md-md-md.md` |
| **Role** | config |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 547 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/batch-prompt-md-md-md-md.md"
project: "narad"
role: config
language: markdown
frameworks: [docker]
...
# batch-prompt-md-md-md-md.md

> Configuration file for the project using **docker** (509 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/batch-prompt-md-md-md-md.md` |
| **Role** | config |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 509 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/batch-prompt-md-md-md.md"
project: "narad"
role: config
language: markdown
frameworks: [docker]
...
# batch-prompt-md-md-md.md

> Configuration file for the project using **docker** (471 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/batch-prompt-md-md-md.md` |
| **Role** | config |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 471 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/batch-prompt-md-md.md"
project: "narad"
role: config
language: markdown
frameworks: [docker]
...
# batch-prompt-md-md.md

> Configuration file for the project using **docker** (433 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/batch-prompt-md-md.md` |
| **Role** | config |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 433 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/unnati/batch-prompt-md.md"
project: "narad"
role: config
language: markdown
frameworks: [docker]
...
> Configuration file for the project using **docker** (395 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/unnati/batch-prompt-md.md` |
| **Role** | config |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 395 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/unnati/career-ops/batch/batch-prompt.md"
project: "unnati"
role: config
language: markdown
frameworks: [docker]
...
> Configuration file for the project using **docker** (357 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `unnati/career-ops/batch/batch-prompt.md` |
| **Role** | config |
| **Language** | markdown |
| **Frameworks** | docker |
| **Lines** | 357 |
