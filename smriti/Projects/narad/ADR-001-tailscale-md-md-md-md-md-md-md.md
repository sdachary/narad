---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/ADR-001-tailscale-md-md-md-md-md-md.md"
project: "narad"
role: deployment
language: markdown
...
# ADR-001-tailscale-md-md-md-md-md-md.md

> Deployment / infrastructure config using **docker, terraform** (646 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/ADR-001-tailscale-md-md-md-md-md-md.md` |
| **Role** | deployment |
| **Language** | markdown |
| **Frameworks** | docker, terraform |
| **Lines** | 646 |
