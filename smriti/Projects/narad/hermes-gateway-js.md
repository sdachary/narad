---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/services/hermes-gateway.js"
project: "narad"
role: service
language: javascript
frameworks: [docker]
...
> Service / API client module using **docker** (342 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/services/hermes-gateway.js` |
| **Role** | service |
| **Language** | javascript |
| **Frameworks** | docker |
| **Lines** | 342 |
