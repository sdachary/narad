---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/matcher-ts-md-md-md-md-md.md"
project: "narad"
role: utility
language: markdown
...
# matcher-ts-md-md-md-md-md.md

> Utility / helper module using **docker, typescript** (456 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/matcher-ts-md-md-md-md-md.md` |
| **Role** | utility |
| **Language** | markdown |
| **Frameworks** | docker, typescript |
| **Lines** | 456 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/matcher-ts-md-md-md-md.md"
project: "narad"
role: utility
language: markdown
frameworks: [docker, typescript]
...
# matcher-ts-md-md-md-md.md

> Utility / helper module using **docker, typescript** (418 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/matcher-ts-md-md-md-md.md` |
| **Role** | utility |
| **Language** | markdown |
| **Frameworks** | docker, typescript |
| **Lines** | 418 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/matcher-ts-md-md-md.md"
project: "narad"
role: utility
language: markdown
frameworks: [docker, typescript]
...
# matcher-ts-md-md-md.md

> Utility / helper module using **docker, typescript** (380 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/matcher-ts-md-md-md.md` |
| **Role** | utility |
| **Language** | markdown |
| **Frameworks** | docker, typescript |
| **Lines** | 380 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/matcher-ts-md-md.md"
project: "narad"
role: utility
language: markdown
frameworks: [docker, typescript]
...
> Utility / helper module using **docker, typescript** (342 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/matcher-ts-md-md.md` |
| **Role** | utility |
| **Language** | markdown |
| **Frameworks** | docker, typescript |
| **Lines** | 342 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/narad/matcher-ts-md.md"
project: "narad"
role: utility
language: markdown
frameworks: [docker, typescript]
...
> Utility / helper module using **docker, typescript** (304 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/narad/matcher-ts-md.md` |
| **Role** | utility |
| **Language** | markdown |
| **Frameworks** | docker, typescript |
| **Lines** | 304 |
...
```markdown
---
source: "/home/runner/work/narad/narad/sync_temp/narad/pages/vault/unnati/matcher-ts.md"
project: "narad"
role: utility
language: markdown
frameworks: [docker, typescript]
...
> Utility / helper module using **docker, typescript** (266 lines).

## 📋 Metadata

| Property | Value |
|----------|-------|
| **Path** | `narad/pages/vault/unnati/matcher-ts.md` |
| **Role** | utility |
| **Language** | markdown |
| **Frameworks** | docker, typescript |
| **Lines** | 266 |
