---
source: "/home/deepak/Work/chitragupta/src/ts/app.ts"
project: "chitragupta"
role: service
language: typescript
...
lines: 900
size: 32013 bytes
last_modified: "2026-04-07 15:55"
scanned: "2026-04-07 15:55"
tags: [code, project/chitragupta, service, typescript, vite]
---

# app.ts

> Service / API client module using **typescript, vite** (900 lines).
...
function renderPartners() {
  ...
  if (partnerSelect) {
    let options = '<option value="">Select Partner</option><option value="shop">Shop / Both</option>';
    state.members.forEach(m => {
